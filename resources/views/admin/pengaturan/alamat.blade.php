                        ...
                        <div class="col-md-12">
                            <table>
                                <tr>
                                    ...
                                    <th>:</th>
                                    <td>{{ $alamat_toko->detail }} , {{ $alamat_toko->kota_toko }} , {{ $alamat_toko->prov_toko }}</td>
                                </tr>
                            </table>
                              <small><a href="{{ route('admin.pengaturan.ubahalamat',['id' =>  $alamat_toko->id]) }}">Klik untuk mengubah alamat toko</a></small>
                        </div>
                    </div>
                  </div>
                </div>
