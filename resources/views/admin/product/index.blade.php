                          ...
                          @foreach($products as $product)
                            <tr>
                                <td align="center">
                                  ...
                                  <td align="center">{{ $product->weigth }}</td>
                                  <td align="left">{{ $product->nama_kategori }}</td>
                                  <td align="center">{{ $product->stok }}</td>
                                  <td align="center"><img src="{{ asset('storage/'.$product->image) }}" width="100px" height="100px"  alt="" ></td>
                                </td>
                                <td align="center">
