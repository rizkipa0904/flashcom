@extends('user.app')
@section('content')
<div class="site-blocks-cover" style="background-image: url({{ asset('shopper') }}/images/hero_1.png);" data-aos="fade">
    <div class="container">
    <div class="row align-items-start align-items-md-center justify-content-end">
        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
        <h1 class="mb-2">Cari Kebutuhan Komputer dan Laptop Anda Di Sini</h1>
        <div class="intro-text text-center text-md-left">
            <p class="mb-4">Service dan Sparepart disini dengan kualitasnya yang terjamin  </p>
            <p>
...
<div class="site-section site-section-sm site-blocks-1">
    ...
    <div class="row">
        ...
        <div class="text">
            ...
            <p>Kualitas barangnya terjamin karena semuanya disini Sparepart dengan kualitas terbaik.</p>
        </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="nonloop-block-3 owl-carousel" >
            ...
            <div class="block-4 text-center">
                ...
                <p class="mb-0"><strong>Rp. {{ number_format( $produk->price,2,',','.') }}</strong></p>
