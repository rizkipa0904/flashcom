...
<html lang="en">
  <head>
    <title>Flash Computer &mdash; Toko Service dan Sparepart Komputer Online </title>
    <meta charset="utf-8">
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-6 col-md-4 order-2 order-md-1 site-search-icon text-left">
             <a class="js-logo-clone" href="/home"><img src="{{ asset('adminassets') }}/assets/images/faces/logo-fc.png" alt="logo" /></a>
                {{-- <a href="#" class="js-logo-clone">Flash Computer</a> --}}
            </div>

            <div class="col-12  col-md-4 order-1 order-md-2 site-search-icon text-center">
    ...
    <footer class="site-footer border-top">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6 col-lg-6">
            <div class="block-5 mb-5">
              ...
              <ul class="list-unstyled">
                <li class="address">Jalan M. Hatta No. 12 Pasar Baru - Padang</li>
                <li class="phone"><a href="tel://+6285161338190">+6285161338190</a></li>
                <li class="email">flashcomputerpdg@gmail.com</li>
              </ul>
            </div>
        ...
        <div style="position:fixed;left:20px;bottom:20px;">
                        <a href="https://api.whatsapp.com/send?phone=6285161338190&text=Halo%20gan,%20Saya%20mau%20mesan jasa service%20terkait%20">
                        <button style="background:#00ffff;vertical-align:center;height:36px;border-radius:5px">
