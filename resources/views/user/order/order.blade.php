...
<div class="site-section">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h2 class="btn btn-danger text-white">Belum Dibayar</h2>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $o->name }}</td>
                        <td>
                        <a href="{{ route('user.order.pembayaran',['id' => $o->id]) }}" class="btn btn-info">Bayar</a>
        ...
        <div class="col-md-12">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                    <a href="{{ route('user.order.detail',['id' => $o->id]) }}" class="btn btn-info">Detail</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h2 class="btn btn-success text-white">Riwayat Pesanan Anda</h2>
        </div>
    </div>
    <div class="row mb-5">
        <div class="col-md-12">
